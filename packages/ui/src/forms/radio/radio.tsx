...
export type RadioProps = Omit<HTMLAttributes<HTMLFieldSetElement>, "onChange" | "defaultValue"> &
  FieldStatusProps & {
    name: string;
    options: FieldOption[];
    value?: string;
...
export function Radio({ name, label, description, errorMessage, successMessage, validationState, isInvalid, isSuccess, options, value, defaultValue = "", onValueChange, required, disabled, className, ...props }: RadioProps) {
