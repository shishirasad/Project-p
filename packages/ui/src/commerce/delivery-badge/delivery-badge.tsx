...
export type DeliveryBadgeProps = HTMLAttributes<HTMLDivElement> & {
  label: ReactNode;
  description?: ReactNode;
  icon?: ReactNode;
};

export function DeliveryBadge({ label, description, icon = <Truck aria-hidden="true" size={17} strokeWidth={1.8} />, className, ...props }: DeliveryBadgeProps) {
  return (
