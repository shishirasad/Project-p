...
const sizeClasses = { sm: "text-sm leading-6", md: "text-base leading-7", lg: "text-lg leading-8" };
...
export function Text({ as, className, size = "md", tone = "default", children, ...props }: TextProps) {
  ...
  return <Component className={cn(sizeClasses[size], toneClasses[tone], className)} {...props}>{children}</Component>;
}
